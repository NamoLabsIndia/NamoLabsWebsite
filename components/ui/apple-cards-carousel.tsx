  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-72 w-48 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[34rem] md:w-[22rem] dark:bg-neutral-900"
      >
